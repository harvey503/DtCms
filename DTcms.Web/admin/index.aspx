  ...
  <div position="top" class="header">
        ...
        <div position="left"  title="管理菜单" id="global_left_nav"> 
            ...
            <%if (siteConfig.memberstatus == 1)
              { %>
            <div title="经销商管理" iconcss="menu-icon-member">
                <ul class="nlist">
                    <%if (IsAdminLevel("users", DTEnums.ActionEnum.View.ToString()))
                      {%>
                    <li><a href="javascript:f_addTab('user_list','经销商信息管理','users/user_list.aspx')">经销商信息管理</a></li>
                    <%}
                      if (IsAdminLevel("user_groups", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('user_groups','经销商组别管理','users/group_list.aspx')">经销商组别管理</a></li>
                    <%}
                      if (IsAdminLevel("user_message", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('user_message','经销商短信管理','users/message_list.aspx')">经销商短信管理</a></li>
                    <%}
                      if (IsAdminLevel("amount_log", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('amount_log','经销商消费记录','users/amount_log.aspx')">经销商消费记录</a></li>
                    <%}
                      if (IsAdminLevel("point_log", DTEnums.ActionEnum.View.ToString()))
                      { %>
                    <li><a href="javascript:f_addTab('point_log','经销商积分记录','users/point_log.aspx')">经销商积分记录</a></li>
                    <%}
                    ...
                    <%}
                      ...
                      { %>
                    <li><a class="l-link" href="javascript:f_addTab('user_config','经销商参数配置','users/user_config.aspx')">经销商参数配置</a></li>
                    <%} %>
                </ul>
            </div>
