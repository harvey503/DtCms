<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oauth_user_list.aspx.cs" Inherits="DTcms.Web.admin.users.oauth_user_list" %>
...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; OAuth平台 &gt; 已授权列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="oauth_list.aspx" class="tools_btn"><span><b class="return">OAuth平台</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        <th width="6%">选择</th>
        <th width="13%" align="left">绑定帐户</th>
        <th width="10%" align="left">授权平台</th>
        <th align="left">Access Token</th>
        <th width="15%" align="left">UId</th>
        <th width="16%" align="left">授权时间</th>
      </tr>
    </HeaderTemplate>
    <ItemTemplate>
      <tr>
