...
<div id="contentTab">
    <ul class="tab_nav">
        <li class="selected"><a onclick="tabs('#contentTab',0);" href="javascript:;">编辑经销商组</a></li>
    </ul>
        ...
        <table class="form_table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <label>*用户注册成功后自动默认为该经销商组，如果存在多条，则以等级值最小的为准。</label>
                </td>
            </tr>
            <tr>
                <th>参与自动升级：</th>
                <td>
                    ...
                    <label>*如果是否，在满足升级条件下系统则不会自动升级为该经销商组。</label>
                </td>
            </tr>
            <tr>
                <th>等级值：</th>
                <td><asp:TextBox ID="txtGrade" runat="server" CssClass="txtInput normal small required digits"></asp:TextBox><label>*升级顺序，取值范围1-100，等级值越大，经销商等级越高。</label></td>
            </tr>
            <tr>
                <th>升级所需积分：</th>
            ...
            <tr>
                <th>初始金额：</th>
                <td><asp:TextBox ID="txtAmount" runat="server" CssClass="txtInput normal small required number"></asp:TextBox><label>*自动到该经销商组赠送的金额，负数则扣减。</label></td>
            </tr>
            <tr>
                <th>初始积分：</th>
                <td><asp:TextBox ID="txtPoint" runat="server" CssClass="txtInput normal small required number"></asp:TextBox><label>*自动到该经销商组赠送的积分，负数则扣减。</label></td>
            </tr>
            <tr>
                <th>购物折扣：</th>
