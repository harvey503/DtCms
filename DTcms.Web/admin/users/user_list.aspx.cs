    ...
    public partial class user_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                userid = Utils.GetCookie("UserId", "DTcms");
                RptBind("id>0" + CombSqlTxt(this.group_id, this.keywords, userid), "reg_time desc,id desc");
            }
        }
        ...
        private void TreeBind(string strWhere)
        {
            ...
            this.ddlGroupId.Items.Add(new ListItem("所有经销商组", ""));
        ...
        #region 组合SQL查询语句==========================
        protected string CombSqlTxt(int _group_id, string _keywords,string _userid)
        {
            ...
            {
                strTemp.Append(" and parentid =" + _userid);//过滤
            }
