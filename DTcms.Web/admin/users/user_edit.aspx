...
<div class="navigation"><a href="javascript:history.go(-1);" class="back">后退</a>首页 &gt; 经销商管理 &gt; 编辑经销商信息</div>
<div id="contentTab">
    <ul class="tab_nav">
    ...
    <div class="tab_con" style="display:block;">
        <table class="form_table">
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rblIsLock" runat="server"  RepeatDirection="Horizontal" RepeatLayout="Flow">
                        ...
                        <asp:ListItem Value="3">禁用经销商</asp:ListItem>
                    </asp:RadioButtonList>
                    <label>*禁用的经销商将无法登录。</label>
                </td>
            </tr>
            <tr>
                <th>用户名：</th>
            ...
            <tr>
                <th>姓 名：</th>
                <td><asp:TextBox ID="txtNickName" runat="server" CssClass="txtInput normal required" maxlength="100"></asp:TextBox><label>*经销商的真实姓名</label></td>
            </tr>
             <tr>
                <th>证件号码：</th>
