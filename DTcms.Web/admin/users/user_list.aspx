...
<form id="form1" runat="server">
    <div class="navigation">首页 &gt; 经销商管理 &gt; 经销商列表</div>
    <div class="tools_box">
	    <div class="tools_bar">
            ...
            <a href="user_edit.aspx?action=<%=DTEnums.ActionEnum.Add %>" class="tools_btn"><span><b class="add">添加经销商</b></span></a>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
      <tr>
        ...
        <th width="12%" align="left">经销商组</th>
    ...
    <ItemTemplate>
      <tr>
        ...
        <td class="user_box">
          ...
          <span>
              <a class="amount" href="javascript:parent.f_addTab('amount_log','经销商消费记录','users/amount_log.aspx?keywords=<%#Eval("user_name")%>');" title="消费记录">余额</a>
              <a class="point" href="javascript:parent.f_addTab('point_log','经销商积分记录','users/point_log.aspx?keywords=<%#Eval("user_name")%>');" title="积分记录">积分</a>
              <a class="msg" href="javascript:parent.f_addTab('user_message','经销商短信管理','users/message_list.aspx?keywords=<%#Eval("user_name")%>');" title="短信息记录">短信息</a>
          </span>
        </td>
