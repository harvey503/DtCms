...
namespace DTcms.DAL
{
    ...
    public partial class users
    {
        ...
        public int Add(Model.users model)
        {
            ...
            strSql.Append("group_id,user_name,password,email,nick_name,avatar,sex,birthday,telphone,mobile,qq,address,safe_question,safe_answer,amount,point,exp,is_lock,reg_time,reg_ip,parent_id)");
